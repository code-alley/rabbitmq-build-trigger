...
public class RemoteBuildTrigger extends Trigger<AbstractProject<?, ?>> {
    ...
    // gitblit으로 부터 전달받은 파라미터를 전달하기위해 담아 놓는다.
    ...
    public JSONArray getJsonParameters(){
    	return jsonParameters;
    }
    
    public void setJsonParameters(JSONArray _jsonArray){
    	jsonParameters = new JSONArray();
    	jsonParameters.addAll(_jsonArray);
