...
public class RemoteBuildListener extends MessageQueueListener {
     ...
     * @return
     */
    public Set<RemoteBuildTrigger> getTrigger() {
    	return triggers;
    }
            ...
            try {
                ...
                try {
                    ...
                    for (RemoteBuildTrigger t : triggers) {
                        ...
                        LOGGER.info("### project name : " + t.getProjectName());
                        ...
                        if (t.getProjectName().equals(json.getString(KEY_PROJECT))
                            ...
                            if (json.containsKey(KEY_PARAMETER)) {
                                ...
                                t.setJsonParameters(json.getJSONArray(KEY_PARAMETER));
                                LOGGER.info("### jsonParameters : " + json.getJSONArray(KEY_PARAMETER));
                            } else {
                                t.scheduleBuild(queueName, null);
                                
                                t.setJsonParameters(null);
                            }
                        }
                    }
